...
import com.qtech.check.constant.ComparisonConstants;
...
import static com.qtech.check.constant.ComparisonConstants.REDIS_COMPARISON_MODEL_KEY_PREFIX;
...
public class AaListParamsCheckMessageConsumer {
    ...
    public void listenBatchMessages(List<ConsumerRecord<String, String>> records) {
        ...
        for (ConsumerRecord<String, String> record : records) {
            ...
            Triple<Map<String, Map.Entry<Object, Object>>, Map<String, Object>, Map<String, Object>> result = AaListParamsComparator.compareObjectsWithStandardAndActual(modelObj, actualObj, ComparisonConstants.PROPERTIES_TO_COMPARE);
            ...
            kafkaTemplate.send("qtech_im_aa_list_checked_topic", JSON.toJSONString(aaListParamsCheckResult));
            log.info(">>>> Checked parsed message!");
        }
    }
}
