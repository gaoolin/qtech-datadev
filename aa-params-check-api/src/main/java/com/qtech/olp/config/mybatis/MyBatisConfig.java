package com.qtech.olp.config.mybatis;

import com.qtech.olp.config.dynamic.DynamicDataSource;
...
@Configuration
@MapperScan(basePackages = "com.qtech.olp.mapper") // 指定Mapper接口的包路径
public class MyBatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DynamicDataSource dynamicDataSource) throws Exception {
        ...
        // 硬编码类型别名的包
        factory.setTypeAliasesPackage("com.qtech.**.entity"); // 替换为你的实际包路径
